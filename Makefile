...
.PHONY: help setup all auto fast list quickstart frames content effects banners advanced showcases applications testing v010 check
...
help:
	...
	@echo "  make v010          Run 10_v010_api examples"
	@echo ""
	@echo "Usage Tips:"
...
v010:
	@python run_examples.py --categories 10_v010_api
